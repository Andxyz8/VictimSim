...
class AbstractAgent:
    ...
    def deliberate(self) -> bool:
        """This is the choice of the next action. The simulator calls this method
            at each reasonning cycle if the agent is ACTIVE.

        Must be implemented in every agent.

        Returns:
            bool: True if there's one or more actions to do, False otherwise.
        """
        pass
